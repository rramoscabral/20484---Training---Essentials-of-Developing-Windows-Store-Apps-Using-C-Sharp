...
namespace ILoveNotes.Pages
{
    ...
    public sealed partial class Splash : ILoveNotes.Common.LayoutAwarePage
    {
        ...
        public Splash(SplashScreen splashScreen, LaunchActivatedEventArgs args)
        {
            ...
            else if (args.Arguments.StartsWith(Consts.SecondaryTileFormat))
            {
                DirectLink = args.Arguments.Substring(args.Arguments.IndexOf("=") + 1);
            }
            Init(splashScreen);
        }
        ...
        async void DataRequested(DataTransferManager sender, DataRequestedEventArgs e)
        {
            ...
            else
            {
                ...
                e.Request.Data.Properties.Description = "I'm using 'I Love Notes' for Windows 8 Metro";
                e.Request.Data.SetWebLink(new Uri("http://www.ILoveNotes.com"));
            }
        }
