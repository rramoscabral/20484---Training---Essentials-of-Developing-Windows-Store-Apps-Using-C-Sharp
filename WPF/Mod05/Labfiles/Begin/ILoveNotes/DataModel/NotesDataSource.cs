...
namespace ILoveNotes.Data
{
    ...
    public sealed class NotesDataSource
    {
        ...
        //Lab 05 : Exercise 1 , Task 1.6 : change the method signature to be async
        public void Load()
        {
            try
            {
                //Lab 05 : Exercise 1 , Task 1.6 : Invoke the LoadAsync method
        ...
        async public static Task DeleteAsync(NoteDataCommon itemToDelete)
        {
            if (itemToDelete.Type == NoteTypes.Notebook)
            {
                ...
                await DataManager.DeleteFileAsync(itemToDelete.UniqueId, FolderNames.Notebooks);
            }
            else
            {
                ...
                DataManager.Save(itemToDelete.NoteBook);
            }
        }
