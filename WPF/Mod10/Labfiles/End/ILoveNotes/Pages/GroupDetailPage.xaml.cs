...
namespace ILoveNotes
{
    ...
    public sealed partial class GroupDetailPage : ILoveNotes.Common.NotesBasePage
    {
        ...
        void UpdateNoteBook()
        {
            //Lab 10, Exercise 2, Task 1.6 : update the UpdateNoteBook method to send tile notification
        ...
        ///Lab 10, Exercise 2, Task 1.3 : Implement the Pin event handler for the App bar Button.
        ///Lab 10, Exercise 2, Task 1.7 : send secondary Tile updates 
