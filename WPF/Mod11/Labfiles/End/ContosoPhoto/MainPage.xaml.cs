...
namespace ContosoPhoto
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void OpeningMessage_Tapped(object sender, TappedRoutedEventArgs e)
        {
            // Invoke the click handler for the Open button
            OnOpenButtonClicked(OpenButton, new RoutedEventArgs());
        }
